...
hitable *final() {
   ...
   list[l++] = new moving_sphere(center, center+vec3(30, 0, 0), 0, 1, 50, new 
           lambertian(new constant_texture(vec3(0.7, 0.3, 0.1))));
   ...
   int nx, ny, nn;
   unsigned char *tex_data = stbi_load("earth_map.jpg", &nx, &ny, &nn, 0);
